...
function process() {
	...
	processedEls.filter((el) => {
		...
		var cssClasses = el.attribs.classname.split(' ').filter(className => className.trim() !== '');
...
function activate(context) {
	let run = vscode.commands.registerCommand('extension.ecsstractor_tsx_port_run', function () {
		config = vscode.workspace.getConfiguration('ecsstractor_tsx_port');
	...
	let runwithbem = vscode.commands.registerCommand('extension.ecsstractor_tsx_port_runwithbem', function () {
		config = vscode.workspace.getConfiguration('ecsstractor_tsx_port');
		add_comments = false;
		brackets = true;
		bem_nesting = true;
	...
	let runwithbemandcomments = vscode.commands.registerCommand('extension.ecsstractor_tsx_port_runwithbemandcomments', function () {
		config = vscode.workspace.getConfiguration('ecsstractor_tsx_port');
		add_comments = true;
		brackets = true;
		bem_nesting = true;
	...
	let runwithoutbem = vscode.commands.registerCommand('extension.ecsstractor_tsx_port_runwithoutbem', function () {
		config = vscode.workspace.getConfiguration('ecsstractor_tsx_port');
		add_comments = false;
		brackets = false;
		bem_nesting = false;
